...
local function run(msg, matches)
  if matches[1]:lower() == 'telebot' then -- Put everything you like :)
    local about = _config.about_text
    local name = user_print_name(msg.from)
    savelog(msg.to.id, name.." ["..msg.from.id.."] used /telebot ")
    return about
  end 
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "telebot" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (telebot)",-- Put everything you like :)
		"^[!/]([Tt]elebot)"-- Put everything you like :)
    }, 
  run = run
}
